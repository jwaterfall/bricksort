...
const Input: FC<InputProps> = ({ label, ...props }) => (
  <div className="flex gap-2 p-3 bg-zinc-200 rounded-sm text-sm font-medium text-zinc-800 border border-zinc-300 min-w-0 dark:bg-zinc-700 dark:text-zinc-50 dark:border-zinc-50/10">

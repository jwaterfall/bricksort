...
export const MenuItem: FC<MenuItemProps> = ({ icon: Icon, rightElement, children, ...props }) => (
    <DropdownMenuPrimitive.Item
        {...props}
        className="px-3 h-12 flex items-center gap-3 outline-none font-medium dark:font-normal text-zinc-600 dark:text-zinc-500 data-[highlighted]:bg-zinc-200 dark:data-[highlighted]:bg-zinc-700"
    >
        {Icon && <Icon size={18} />}
        <span className="flex-1 text-sm text-zinc-950 dark:text-zinc-50">{children}</span>

...
export const TabButton: FC<PropsWithChildren<TabButtonProps>> = (props) => (
  <TabsPrimitive.Trigger
    className={`
      h-16 text-sm font-medium dark:font-normal whitespace-nowrap transition-colors text-slate-500 relative hover:text-slate-900 aria-selected:text-blue-600 aria-selected:hover:text-blue-600
      ...
      dark:text-slate-200 dark:hover:text-slate-50 dark:aria-selected:text-blue-300 dark:aria-selected:hover:text-blue-300 dark:after:bg-blue-300
